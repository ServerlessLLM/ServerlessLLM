...
:::tip
Directly installing vLLM v0.5.0.post1 may not work with ROCm 6.2.0. If you face such issue, a temporary solution is to build a wheel inside ROCm 6.1 docker environment and install the wheel in ROCm 6.2.0. We are currently working on update the supported pytorch and vLLM version to fix this issue.
