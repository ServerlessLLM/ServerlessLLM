...
def save_dict(state_dict: Dict[str, torch.Tensor], model_path: str):
...
def load_dict_single_device(
    ...
    replica_uuid, state_dict, device_map = request_load_into_gpu(model_path, device_map, storage_path)
